...
FileCreateDir, %A_ScriptDir%\Server Boss All\Presets
FileCreateDir, %A_ScriptDir%\Server Boss All\Presets\Advanced
...
if (FileFromFileExplorer = true)
{
    ...
    {
        FileCreateDir, %A_ScriptDir%\Server Boss All\Dropped files
        FileCreateDir, %A_ScriptDir%\Server Boss All\Dropped files\maps
